...
(function() {
  var AsyncSoundManager, GameBoard, SeedRandom, SinkTile, SourceTile, Tile, TileGraphics, TubeTile, TubetasticGame, d, _ref, _ref1, _ref2,
  ...
  TubeTile = (function(_super) {
    ...
    TubeTile.prototype.resize = function(x, y, s) {
      var gfxArc, gfxBack, path, _i, _len;
    ...
    TubeTile.prototype.onClick = function() {
      if (!this.board.ready) {
        return;
      }
      this.spinRemain++;
  ...
  TubetasticGame = (function() {
    function TubetasticGame(canvasName) {
      ...
      board = new GameBoard(this.stage, 8, 7);
